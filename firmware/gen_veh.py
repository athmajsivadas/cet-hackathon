...
// ============================================================
#define VEHICLE_ID          '{v_id}'   // 'A' or 'B'
#define VEHICLE_TIER          {v_tier}   // 1 = Critical, 2 = Standard
#define BEACON_STAGGER_MS     {v_stag}   // 0 for A, 250 for B
// ============================================================
...
for folder, v_id, tier, stag in configs:
    code = template.format(v_id=v_id, v_tier=tier, v_stag=stag)
    p = os.path.join(base_dir, folder, f'{folder}.ino')
    with open(p, 'w', encoding='utf-8') as f:
        f.write(code)

print('Updated vehicle folders!')
